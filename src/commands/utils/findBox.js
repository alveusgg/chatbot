...
const { scenePositions, customCommandAlias, axisCameraCommandMapping, multiScenes } = require('../../config/config');
...
module.exports = (database, xcord, ycord) => {
  ...
  let sceneLayout;
    ...
    return { x, y, sourceWidth, sourceHeight, scaleX, scaleY, ptzCameraName, zone };
}
